...
[~, Vqit] = ode45(@(tspan, Vqi0) part_ode(tspan, ...
                Vqi0, rad, Npb, Dgi, Vi0, Vqi0, Cgqt0, rho, VgT), tspan, Vqi0);
...
disp(Cgqt)
    ...
    function V1 = part_ode(~, Vqit, rad, Npb, Dgi, Vit, Vqith, Cgqt, rho, VgT)
    %function C1 = part_ode(~, Cgqt, rad, Npb, Dgi, Vit, Vqith, rho, VgT)
        ...
        %kimt = part_tran_rate(rad, Npb, Dgi, Vit, Vqith, Vqit);
